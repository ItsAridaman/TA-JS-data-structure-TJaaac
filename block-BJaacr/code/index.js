...
for(let people1 of got.houses[0].people )
{
...
for(let people2 of got.houses[1].people )
{
...
for(let people3 of got.houses[1].people )
{
  console.log(people3.description);
}
...
for(let people3 of got.houses[1].people )
{
  console.log(`i am ${people3.name} & my bio is: ${people3.description}`);
}
...
for(let people4 of got.houses[0].people )
{
  console.log(`i am ${people4.name} & my bio is: ${people4.description}`);
}
...
for(let people4 of got.houses[1].people )
{
  if(people4.name==="Tywin Lannister")
  {
  console.log(`i am ${people4.name} & my bio is: ${people4.description}`);
}
else
...
for(let house of got.houses)
{
  for(let people4 of house.people)
  {
...
for(let house of got.houses)
{
  for(let people4 of house.people)
  {
     allPeople.push(people4.description)
  }
...
for(let house of got.houses)
{
  for(let people4 of house.people)
  {
    if(people4.description.length >60)
    {
    console.log(people4.description);
    console.log(people4.description.length);
